...
AMetalGearSlothCharacter::AMetalGearSlothCharacter()
{
	...
	GetCharacterMovement()->JumpZVelocity = 700.f * 0.75f;
	GetCharacterMovement()->AirControl = 0.35f;
	GetCharacterMovement()->MaxWalkSpeed = 500.f * 0.125f;
	GetCharacterMovement()->MinAnalogWalkSpeed = 20.f * 0.25f;
...
void AMetalGearSlothCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AMetalGearSlothCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMetalGearSlothCharacter::Move);
...
void AMetalGearSlothCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AMetalGearSlothCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
